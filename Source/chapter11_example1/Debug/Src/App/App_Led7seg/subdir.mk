...
C_SRCS += \
../Src/App/App_Led7seg/app_led7seg.c 

OBJS += \
./Src/App/App_Led7seg/app_led7seg.o 

C_DEPS += \
./Src/App/App_Led7seg/app_led7seg.d 


# Each subdirectory must supply rules for building sources it contributes
Src/App/App_Led7seg/%.o Src/App/App_Led7seg/%.su Src/App/App_Led7seg/%.cyclo: ../Src/App/App_Led7seg/%.c Src/App/App_Led7seg/subdir.mk
...
clean: clean-Src-2f-App-2f-App_Led7seg

clean-Src-2f-App-2f-App_Led7seg:
	-$(RM) ./Src/App/App_Led7seg/app_led7seg.cyclo ./Src/App/App_Led7seg/app_led7seg.d ./Src/App/App_Led7seg/app_led7seg.o ./Src/App/App_Led7seg/app_led7seg.su

.PHONY: clean-Src-2f-App-2f-App_Led7seg
