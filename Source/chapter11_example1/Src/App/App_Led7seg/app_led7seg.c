...
void app_led7seg_init(void)
{
	...
	soft_timer_register_callback(SOFT_TIMER_BLINK_LED7SEG, app_led7seg_blink_timer_callback);

	soft_timer_set(SOFT_TIMER_SCAN_LED7SEG, APP_LED7SEG_SCAN_INTERVAL, APP_LED7SEG_SCAN_INTERVAL);
	soft_timer_register_callback(SOFT_TIMER_SCAN_LED7SEG, app_led7seg_scan_timer_callback);
