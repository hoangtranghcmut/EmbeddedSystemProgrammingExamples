...
static void MX_ADC1_Init(void)
{
  ...
  */
  ...
  /* Kích hoạt ADC */
   ...
   /* Hiệu chuẩn ADC (tùy chọn, nhưng nên có) */
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  GPIO_InitStruct.Pin = WATER_LOWER_SENSOR_Pin|RESUME_BUTTON_Pin|WATER_UPPER_SENSOR_Pin;
  ...
  /**/
  GPIO_InitStruct.Pin = BUTTON_UP_Pin|BUTTON_DOWN_Pin|BUTTON_SET_Pin|BUTTON_ONOFF_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_UP;
  LL_GPIO_Init(GPIOB, &GPIO_InitStruct);
